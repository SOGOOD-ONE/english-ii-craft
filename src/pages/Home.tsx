...
export default function HomePage({ onSelectTab }: HomePageProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4 space-y-8 select-none">
      {/* 简明标题区 */}
      <motion.div 
        ...
        {modules.map((m) => {
          ...
          return (
            <motion.div
              ...
              className="group cursor-pointer rounded-xl p-5 border border-zinc-200 hover:border-zinc-400 bg-white shadow-xs flex flex-col justify-between transition-all"
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className={`w-9 h-9 rounded-lg flex items-center justify-center font-bold text-sm shadow-xs ${m.color}`}>
