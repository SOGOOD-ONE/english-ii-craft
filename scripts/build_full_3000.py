...
# -*- coding: utf-8 -*-
"""
考研英语二 (2010-2026) 3000 核心词汇与短语全量生成脚本
"""
import json
import os
import re
...
JSON_PUB = "./public/data/exam_vocab_3000.json"
JSON_SRC = "./src/content/vocab/exam_vocab_3000.json"
CSV_PUB = "./public/data/exam_vocab_3000.csv"
...
print("Writing full 3000 vocabulary data...")
